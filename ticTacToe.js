...
(function (root) {
  ...
  Game.prototype.run = function () {
    ...
    game.turn(function(){
      if (game.winner()) {
        $('#player').html("You Won, " + game.player + "!")
        //READER.close();
      } else {
        game.printBoard();
        game.run();
  ...
  Game.prototype.turn = function (callback) {
    var game = this;
    if(game.player === 'X') {
      $('#player').removeClass('playerfont1');
      $('#player').addClass('playerfont2');
      $('#player').html('Go, go, O!');
    }
    if(game.player === 'O') {
      $('#player').removeClass('playerfont2');
      $('#player').addClass('playerfont1');
      $('#player').html('Go, go, X!');
    }
    ...
    $('.square').on('click', function() {
      ...
      $(this).removeClass();
      if(game.player === 'X') {
        $(this).addClass('square player1');
      }
      if(game.player === 'O') {
        $(this).addClass('square player2');
      }
